<%-- 
    Document   : EditMenu
    Created on : May 31, 2022, 1:28:23 AM
    Author     : fakhr
--%>
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li>
                    <a href="viewMenu.jsp" class="active">
        ...
        <section class="home-section">
            ...
            <div class="home-content">
                <form class="form-register" method="post" onsubmit="return validate();" action="updateMenuProcess.jsp">
                    <div class="form-register-with-email">
                        <div class="form-white-background">
                            ...
                            <div class="form-row">
                                <label>
                                    <span>Dish ID</span>
                                    <input type="text" name="txt_id" id="dishID" value="<%=resultSet.getString("DishID") %>" readonly>
                                </label>
                            </div>
                            <div class="form-row">
                                <label>
                                    <span>Name</span>
                                    <input type="text" name="txt_name" id="name" value="<%=resultSet.getString("Name") %>">
                                </label>
                            </div>
                            <div class="form-row">
                                <label>
                                    <span>Price</span>
                                    <input type="text" name="txt_price" id="price" value="<%=resultSet.getString("Price") %>">
                                </label>
                            </div>
                            <div class="form-row">
                                <label>
